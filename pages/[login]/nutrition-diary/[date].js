...
// import '../../../styles/nutrition-diary.module.css'
// import AddProductsToNutritionDiary from "../../../components/dialogs/addProductsToNutritionDiary/AddProductsToNutritionDiaryDialog";

const NutritionDiary = () => {
  const router = useRouter()
  return (
    <div className="NutritionDiary">
      {/* <AddProductsToNutritionDiary/> */}
