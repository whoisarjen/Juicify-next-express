...
jest.mock('./useDailyMeasurement')

function setup() {
//     const response = {}
//     function TestHook() {
//         Object.assign(response, useDailyMeasurement('2022-02-14', 'Arjen').mockReturnValue({ data: {}}))
//         return null
//     }
//     render(
...
// jest.spyOn(useDailyMeasurement, 'useDailyMeasurement').mockReturnValue({})
