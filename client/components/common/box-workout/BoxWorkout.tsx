...
import { useBoxWorkoutProps } from './useBoxWorkout';
...
const BaseBoxWorkout = ({ title = '', description = '', route, type, isNotSaved, whenAdded, getTheme, t }: useBoxWorkoutProps) => {
    return (
