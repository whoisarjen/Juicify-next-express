...
const BaseDiagramsSectionButtons = ({ router, isAddActivity, setIsAddActivity, activity, setActivity, burnt, setBurnt, addNewActivity, t }: useDiagramsSectionButtonsProps) => {
    return (
        <Box>
            <Buttons>
                <div />
