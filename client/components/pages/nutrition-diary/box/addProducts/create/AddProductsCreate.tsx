...
import { useAddProductsCreateProps } from './useAddProductsCreate';

const BaseAddProductsCreate = ({ closeCreateProduct, isCreateProduct, defaultBarcode, handleSubmit, register, onSubmit, errors, code, setCode, loading, t }: useAddProductsCreateProps) => {
    return (
...
export default BaseAddProductsCreate;