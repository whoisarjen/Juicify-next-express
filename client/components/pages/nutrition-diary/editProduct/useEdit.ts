...
import { DialogEditProductProps } from ".";
import { useAppSelector } from "../../../../hooks/useRedux";

const useEdit = ({ product, isDialog, closeDialog, deleteProduct, changeProduct }: DialogEditProductProps) => {
...
export type useEditProps = ReturnType<typeof useEdit>
