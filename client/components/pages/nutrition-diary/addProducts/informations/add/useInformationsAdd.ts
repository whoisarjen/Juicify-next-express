...
const useInformationsAdd = ({ isAdd, setIsAdd, dailyMeasurement, defaultMeal = 0, loadedProduct }: DiagramsOptionsProps) => {
...
export type useInformationsAddProps = ReturnType<typeof useInformationsAdd>

export default useInformationsAdd;